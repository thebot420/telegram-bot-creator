...
# --- PAGE SERVING ROUTES ---
@app.route('/')
def serve_login_page(): return send_from_directory('templates', 'index.html')
@app.route('/dashboard.html')
def serve_dashboard(): return send_from_directory('templates', 'dashboard.html')
@app.route('/manage/<bot_id>')
def serve_manage_page(bot_id): return send_from_directory('templates', 'manage.html')
@app.route('/orders/<bot_id>')
def serve_orders_page(bot_id): return send_from_directory('templates', 'orders.html')
@app.route('/admin')
def serve_admin_login_page(): return send_from_directory('templates', 'admin.html')
@app.route('/admin/dashboard')
def serve_admin_dashboard(): return send_from_directory('templates', 'admin_main_dashboard.html')
@app.route('/admin/users')
def serve_admin_users_page(): return send_from_directory('templates', 'admin_users.html')
@app.route('/admin/users/<user_id>')
def serve_user_details_page(user_id): return send_from_directory('templates', 'admin_user_details.html')
@app.route('/admin/orders')
def serve_master_orders_page(): return send_from_directory('templates', 'admin_orders.html')
@app.route('/<path:path>')
def serve_static_files(path): return send_from_directory('static', path)
